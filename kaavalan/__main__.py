...
from kaavalan import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from kaavalan.modules import ALL_MODULES
from kaavalan.modules.helper_funcs.chat_status import is_user_admin
from kaavalan.modules.helper_funcs.misc import paginate_modules
from kaavalan.modules.translations.strings import tld, tld_help 
from kaavalan.modules.connection import connected

PM_START = """Hello {}, my name is {}!
 i am a powerful group management bot . u can add me to your super groups . 

Activate Anti-spam protection in your BM by this command : 
/antispam on 

ownership of bot - ✓ [vaasukionfire7966](https://t.me/vaasukionfire7966)

Click /help or Help button below to find out more about how to use me to my full potential.

 Add me to a group by clicking [here](http://t.me/kaavalan?startgroup=true).
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("kaavalan.modules." + module_name)
