...
Saya adalah bot manajer grup yang dikelola oleh [orang ini](tg://user?Id={998920177}). Saya adalah [Marie](https://github.com/sakhaavvaavaj93/shikhamanibot) fork.
...
[disini](https://github.com/sakhaavvaavaj93/kaavalan))!
