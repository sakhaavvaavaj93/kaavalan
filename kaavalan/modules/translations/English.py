...
EnglishStrings = {
    "send-start": """Hi {}, my name {}! If you have any questions on how to use me, read /help - and then head to God.

I'm a group manager bot maintained by [this person](tg://user?id={998920177}). I'm a [Marie](https://github.com/sakhaavvaavaj93/shikhamanibot) fork.
I'm built in python3, using the \
python-telegram-bot library, and am fully opensource - you can find what makes me tick\
[here](https://github.com/sakhaavvaavaj93/kaavalan)!

Feel free to submit pull requests on github, or to contact my support group, പിന്നെ ഇപ്പൊ തന്നെ തരാം ..... നോക്കി ഇരുന്നോ ..... ഇപ്പൊ വരും , with any bugs, questions \
