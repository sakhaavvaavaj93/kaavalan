...
from kaavalan import dispatcher, LOGGER
from kaavalan.modules.disable import DisableAbleCommandHandler
from kaavalan.modules.helper_funcs.chat_status import user_admin
from kaavalan.modules.helper_funcs.extraction import extract_text
from kaavalan.modules.helper_funcs.filters import CustomFilters
from kaavalan.modules.helper_funcs.misc import build_keyboard
from kaavalan.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from kaavalan.modules.sql import cust_filters_sql as sql

from kaavalan.modules.translations.strings import tld
                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol. Telegram "
                                           ...
                                           "again, or ask in @kaavalanAyaGroup for help.")
                        ...
                        try:
                            message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in @kaavalanAyaGroup if you can't figure out why!")
