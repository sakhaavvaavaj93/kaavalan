...
from kaavalan import dispatcher, OWNER_ID, SUDO_USERS, WHITELIST_USERS, MESSAGE_DUMP, LOGGER
from kaavalan.modules.helper_funcs.handlers import CMD_STARTERS
from kaavalan.modules.helper_funcs.misc import is_module_loaded, send_to_list
from kaavalan.modules.helper_funcs.chat_status import is_user_admin
from kaavalan.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from kaavalan.modules.helper_funcs.string_handling import markdown_parser
from kaavalan.modules.disable import DisableAbleCommandHandler

import kaavalan.modules.sql.feds_sql as sql
...
def new_fed(bot: Bot, update: Update):
	...
	if not fednam == '':
		...
		if not x:
			update.effective_message.reply_text("Federation creation failed! Keep in the mind that this rarely happened! Ask in @kaavalanAyaGroup for help!")
			return
