...
from kaavalan.modules.helper_funcs.msg_types import Types
from kaavalan.modules.sql import SESSION, BASE

DEFAULT_WELCOME = "ഡേയ് {first}, വന്നു കയറി ഇരിക്കുന്നതൊക്കെ കൊള്ളാം .... പേര് എന്താണ് ? എവിടെ നിന്നാണ് വന്നത് ? എന്താ പണി ? ഞങ്ങൾക്ക് പണി ഉണ്ടാക്കരുത് .... "
DEFAULT_GOODBYE = "പോടാ {first}, .... പോ ..... അല്ലേലും നീയൊക്കെ പോകേണ്ടവർ തന്നെ ... അല്ലാതെ ഇവിടെ നിന്നിട്ട് കാര്യം ഇല്ലല്ലോ ....നിന്നെ എന്നെങ്കിലും എൻ്റെ കയ്യിൽ കിട്ടും ..... "
